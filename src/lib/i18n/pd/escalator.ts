export const escalator = {
  en: {
    ...
    "escalator.legend.p_elec": "Pₑ, electrical power into the motor",
    "escalator.legend.p_mech": "Pₘ, mechanical power out to the belt",
    ...
    "escalator.equations.theory.mechanical":
      "Mechanical power: lifting is just gaining gravitational potential energy over time. Raising n people of mass m by a height h takes work n·m·g·h, and dividing by the time t gives the useful power the escalator must deliver, Pₘ — the same rate a single elevator would need, just averaged over a continuous stream of riders.",
    "escalator.equations.theory.losses":
      "Where does the rest go? A real motor/escalator assembly never converts 100% of its electrical input into useful lift. Electrical losses (Joule heating I²R in the windings, iron losses in the core) and mechanical losses (friction in bearings, the gearbox, and the step chain) all end up as waste heat. The efficiency η = Pₘ / Pₑ is exactly the fraction that escapes that waste and reaches the passengers.",
    ...
    "escalator.equations.note.reference":
      "Pₑ = √3 × 380 V × 5.365 A × 0.9 ≈ 3.18 kW.\n" +
      "Pₘ = (30 × 75 kg × 9.81 × 7 m) / 60 s ≈ 2.58 kW.\n" +
      "η = Pₘ / Pₑ ≈ 81.0%.",
  ...
  es: {
    ...
    "escalator.legend.p_elec": "Pₑ, potencia eléctrica hacia el motor",
    "escalator.legend.p_mech": "Pₘ, potencia mecánica hacia la cinta",
    ...
    "escalator.equations.theory.mechanical":
      "Potencia mecánica: elevar es simplemente ganar energía potencial gravitatoria en el tiempo. Subir n personas de masa m una altura h requiere un trabajo n·m·g·h, y dividiendo por el tiempo t se obtiene la potencia útil que debe entregar la escalera, Pₘ — la misma que necesitaría un solo ascensor, promediada sobre un flujo continuo de pasajeros.",
    "escalator.equations.theory.losses":
      "¿Adónde va el resto? Un conjunto motor/escalera real nunca convierte el 100% de su entrada eléctrica en elevación útil. Las pérdidas eléctricas (efecto Joule I²R en los bobinados, pérdidas en el hierro del núcleo) y las pérdidas mecánicas (fricción en los rodamientos, la caja reductora y la cadena de peldaños) terminan como calor disipado. El rendimiento η = Pₘ / Pₑ es exactamente la fracción que escapa a ese desperdicio y llega a los pasajeros.",
