export const bankedCurve = {
  en: {
    ...
    "bc.equations.statement.text":
      "Hibbeler, Engineering Mechanics: Dynamics — problems 13-53 and 13-54. 13-53: The sports car has a mass of 1700 kg and travels horizontally along a 20° banked track which is circular and has a radius of curvature ρ = 100 m. If the coefficient of static friction between the tyres and the track is μs = 0.2, determine the maximum constant speed at which the car can travel without sliding up the slope. Neglect the size of the car. 13-54 — With the same data, determine the minimum speed at which the car can travel around the track without sliding down the slope.",
