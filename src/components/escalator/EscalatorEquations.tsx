      ...
      {open && (
        ...
        >
          ...
          <div className="font-mono">
            ...
            <p>{withSubscripts("P_elec")} = √3 · V · I · cos φ</p>
            <p>
              {withSubscripts("P_mec")} = (n · m · g · h) / t
            </p>
            <p>η = {withSubscripts("P_mec")} / {withSubscripts("P_elec")}</p>
          </div>
          ...
          <div>
            ...
            <p className="font-sans leading-relaxed text-gray-500 dark:text-gray-400">
              {t("escalator.equations.note.reference")}
            </p>
          </div>
