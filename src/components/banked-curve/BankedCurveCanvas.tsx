...
import { useBankedCurveAnimationLoop } from "@/hooks/useBankedCurveAnimationLoop";
...
export function BankedCurveCanvas({
  params,
  visibility,
  phaseRef,
  cameraRef,
  ...
  return (
    <canvas
      ...
      aria-label={t("bc.page.canvas_aria")}
