...
export const RingEnergyChart = memo(function RingEnergyChart({
  ...
  return (
    <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-2 bg-white dark:bg-gray-900">
      <div className="flex items-center justify-between px-1 pb-1">
        ...
        <div className="flex gap-3">
          <div className="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
            <span className="inline-block w-3 h-2" style={{ backgroundColor: COLORS.energyKE }} />
            <span>{t('ring.energy.ke')}</span>
          </div>
          <div className="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
            <span className="inline-block w-3 h-2" style={{ backgroundColor: COLORS.energyPE }} />
      ...
      />
      {eTotal <= 0.5 && (
        <p className="text-[10px] text-gray-500 dark:text-gray-400 px-1 pt-1">
